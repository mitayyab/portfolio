...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-rule bg-bg">
      <Container className="flex items-center gap-3 py-3.75 whitespace-nowrap lg:gap-6.5 lg:py-5">
        <Link
          href="/"
        ...
        <span className="hidden font-mono text-mono-sm tracking-[0.13em] text-muted uppercase xl:inline">
          {`${site.role} · ${site.city}`}
        </span>
