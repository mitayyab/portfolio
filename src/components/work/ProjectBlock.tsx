  ...
  return (
    <article className="border-t border-rule py-6.5 first:border-t-0 first:pt-0 lg:grid lg:grid-cols-2 lg:items-center lg:gap-12 lg:py-12">
      ...
      <div className="mt-3.5 lg:mt-0">
        ...
        <p className="mt-2.5 max-w-[62ch] text-[0.875rem] leading-[1.75] text-text-2 lg:mt-3 lg:max-w-[50ch] lg:text-justify lg:text-[0.90625rem] lg:leading-[1.8] lg:hyphens-auto">
          <Copy text={body} />
        </p>
